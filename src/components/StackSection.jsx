...
const StackSection = ({ stack }) => {
  return (
    <section id="stack" className="py-20">
      <h2 className="text-sectionTitle text-gTitle mb-16">Skill & Tool</h2>

      <div className="space-y-20">
        {stacks.map((category) => (
          <div
            key={category.category}
            className="flex items-center gap-14 flex-wrap md:flex-nowrap ml-6"
          >
            <h3 className="text-sectionSubTitle text-gTitle w-[140px] shrink-0">
              {category.category}
            </h3>
